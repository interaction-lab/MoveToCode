...
namespace MoveToCode {
    public class MoveObjectMesh : SingleRightArgObjectMesh {
        protected override void ResizeObjectMesh() {
            ...
            float? horizontalSize = GetComponent<SnapColliderGroup>().SnapColliderSet[CommonSCKeys.Move]?.MyCodeBlockArg?.GetCodeBlockObjectMesh().GetBlockHorizontalSize();
