...
namespace MoveToCode {
    public class SetColorObjectMesh : SingleRightArgObjectMesh {
        protected override void ResizeObjectMesh() {
            ...
            float? horizontalSize = GetComponent<SnapColliderGroup>().SnapColliderSet[CommonSCKeys.Color]?.MyCodeBlockArg?.GetCodeBlockObjectMesh().GetBlockHorizontalSize();
