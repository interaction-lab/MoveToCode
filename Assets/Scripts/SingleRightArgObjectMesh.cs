...
namespace MoveToCode {
    public class SingleRightArgObjectMesh : CodeBlockObjectMesh {
        ...
        public override float GetBlockVerticalSize() {
            return top.localScale.y + FindChainSize(GetMyCodeBlock().GetArgumentFromDict(IARG.Nested));
        }
        ...
        protected override void ResizeObjectMesh() {
            ...
            float? horizontalSize = GetMyCodeBlock().GetArgAsCodeBlock(IARG.Conditional)?.GetCodeBlockObjectMesh().GetBlockHorizontalSize();
