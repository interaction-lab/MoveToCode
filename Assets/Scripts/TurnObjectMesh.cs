...
namespace MoveToCode {
    public class TurnObjectMesh : SingleRightArgObjectMesh {
        protected override void ResizeObjectMesh() {
            ...
            float? horizontalSize = GetComponent<SnapColliderGroup>().SnapColliderSet[CommonSCKeys.Turn]?.MyCodeBlockArg?.GetCodeBlockObjectMesh().GetBlockHorizontalSize();
